...
\begin{enumerate}
	\item Sprawdzamy czy wierzchołek startowy jest dopuszczalny (nie jest w kolizji).
...
\textbf{Rozkład LU}
$$PA = LU$$
Rozkład LU możemy uzyskać za pomocą eliminacji Gaussa, ale bez "doklejania" do $A$ wektora $b$. Wtedy z eliminacji otrzymujemy macierz schodkową, czylu $U$, a $L$ to złożenie operacji elementarnych na $A$, które doprowadziłY do $U$. Znając rozkład L i U mamy złożoność $O(n^2)$.\\
